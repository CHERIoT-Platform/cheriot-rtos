...
#define TEST_NAME "MiBench-sha"
#include <stdlib.h>
#include <string.h>
#include "mibench_sha.h"
#include "tests.hh"
...
void sha_stream(SHA_INFO *sha_info, const char *fin, size_t fin_size)
{
    size_t readbyte = 0;
...
void test_mibench_sha()
{
    SHA_INFO info;
    sha_stream(&info, input, sizeof(input));
    sha_print(&info);
}
