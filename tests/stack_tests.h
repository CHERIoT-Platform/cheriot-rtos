...
__cheri_compartment(
  "stack_integrity_"
  "thread") void test_stack_permissions_on_fault(bool         *outTestFailed,
                                                 PermissionSet newPermissions);
__cheri_compartment(
  "stack_integrity_"
  "thread") void test_stack_permissions_on_compartment_call(bool *outTestFailed,
                                                            PermissionSet
                                                              newPermissions,
...
__cheri_compartment(
  "stack_integrity_"
  "thread") void test_stack_invalid_on_cross_compartment_call(bool
                                                                *outTestFailed,
                                                              __cheri_callback void (
                                                                *fn)());
