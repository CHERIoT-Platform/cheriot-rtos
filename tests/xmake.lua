...
compartment("stack_exhaustion_thread")
        add_files("stack_exhaustion_thread.cc")
compartment("stack_metadata")
        add_files("stack_metadata.cc")
test("stack")
...
firmware("test-suite")
    ...
    add_deps("stack_test", "stack_exhaustion_trusted", "stack_exhaustion_thread", "stack_metadata")
