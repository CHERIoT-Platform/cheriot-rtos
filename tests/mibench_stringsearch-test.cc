...
#define TEST_NAME "MiBench-stringsearch"
#include <debug.hh>
#include <assert.h>
#include <stddef.h>
#include <string.h>
...
"me",
"\0haha"};
const char **find_strings = _find_strings;

const char *_search_strings[] = { "Kurt Vonneguts Commencement Address at",
...
const char **search_strings = _search_strings;

void test_mibench_stringsearch()
{
      char *here;
    ...
    debug_log("Stringsearch, with {} successes, {} fails.\n", foundcnt, nfoundcnt);
}
