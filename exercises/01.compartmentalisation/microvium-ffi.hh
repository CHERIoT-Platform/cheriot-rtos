...
namespace
{
	...
	/**
	 * The concrete specialisation that decomposes the function type for local
	 * functions.
	 */
	...
	/**
	 * The concrete specialisation that decomposes the function type for
	 * functions that are cross-compartment calls.
	 */
	template<typename R, typename... Args>
