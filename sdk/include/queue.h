 ...
 * should use `queue_destroy` instead of this API, this exist to support
...
/**
 * Returns a copy of `handle` with a subset of permissios.  The `permissions`
 * argument is a bitmask of `MessageQueuePermission` values.  The returned
 * handle have only the permissions that are both already present on `handle`
