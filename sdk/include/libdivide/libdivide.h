...
static LIBDIVIDE_CONSTEXPR struct libdivide_s16_t libdivide_s16_gen(int16_t d);
static LIBDIVIDE_CONSTEXPR struct libdivide_u16_t libdivide_u16_gen(uint16_t d);
static LIBDIVIDE_CONSTEXPR struct libdivide_s32_t libdivide_s32_gen(int32_t d);
static LIBDIVIDE_CONSTEXPR struct libdivide_u32_t libdivide_u32_gen(uint32_t d);
static LIBDIVIDE_CONSTEXPR struct libdivide_s64_t libdivide_s64_gen(int64_t d);
static LIBDIVIDE_CONSTEXPR struct libdivide_u64_t libdivide_u64_gen(uint64_t d);

static LIBDIVIDE_CONSTEXPR struct libdivide_s16_branchfree_t libdivide_s16_branchfree_gen(int16_t d);
static LIBDIVIDE_CONSTEXPR struct libdivide_u16_branchfree_t libdivide_u16_branchfree_gen(uint16_t d);
static LIBDIVIDE_CONSTEXPR struct libdivide_s32_branchfree_t libdivide_s32_branchfree_gen(int32_t d);
static LIBDIVIDE_CONSTEXPR struct libdivide_u32_branchfree_t libdivide_u32_branchfree_gen(uint32_t d);
static LIBDIVIDE_CONSTEXPR struct libdivide_s64_branchfree_t libdivide_s64_branchfree_gen(int64_t d);
static LIBDIVIDE_CONSTEXPR struct libdivide_u64_branchfree_t libdivide_u64_branchfree_gen(uint64_t d);
...
static LIBDIVIDE_CONSTEXPR int32_t libdivide_count_leading_zeros64(uint64_t val) {
...
static LIBDIVIDE_CONSTEXPR uint64_t libdivide_128_div_64_to_64(
...
static LIBDIVIDE_CONSTEXPR struct libdivide_u16_t libdivide_internal_u16_gen(
...
static LIBDIVIDE_CONSTEXPR struct libdivide_u32_t libdivide_internal_u32_gen(
...
static LIBDIVIDE_CONSTEXPR struct libdivide_u64_t libdivide_internal_u64_gen(
...
static LIBDIVIDE_CONSTEXPR struct libdivide_s16_t libdivide_internal_s16_gen(
...
static LIBDIVIDE_CONSTEXPR struct libdivide_s32_t libdivide_internal_s32_gen(
...
static LIBDIVIDE_CONSTEXPR struct libdivide_s64_t libdivide_internal_s64_gen(
...
#define DISPATCHER_GEN(T, ALGO)                                                       \
    ...
    LIBDIVIDE_CONSTEXPR dispatcher(T d) : denom(libdivide_##ALGO##_gen(d)) {}            \
...
class divider {
   ...
   public:
    ...
    LIBDIVIDE_CONSTEXPR divider(T d) : div(d) {}
