...
Beyond that, you just need the flags to specify the target and ABI: `-target riscv32-unknown-cheriotrtos -mcpu=cheriot -mabi=cheriot -mxcheri-rvc -mrelax -fshort-wchar`.
